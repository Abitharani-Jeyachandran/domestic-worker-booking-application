    ...
    <div class="site-section section">
          <div class="container">
            ...
            <div class="row align-items-stretch">
              <div class="col-lg-6">
                <a href="login-worker.php" class="service">
                  <span class="wrap-icon brand-adobeillustrator"></span>
                  <h1>Domestic Worker</h1></br><h3>Login</h3>
                </a>
                <h3>Not Registered Yet? <a href="">Register Here</a></h3>
              </div>
              <div class="col-lg-6">
                <a href="login-user.php" class="service">
                  <span class="wrap-icon brand-adobephotoshop"></span>
                  <h1>Help Seeker</h1></br><h3>Login</h3>
                </a>
                <h3>Not Registered Yet? <a href="">Register Here</a></h3>
              </div>
            </div>
