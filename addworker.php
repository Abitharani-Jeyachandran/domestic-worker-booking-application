...
if(isset($_POST)) {
	...
	$worker_fullname = mysqli_real_escape_string($conn, $_POST['worker_fullname']);
  ...
  $worktype = mysqli_real_escape_string($conn, $_POST['worktype']);
	...
	$sql = "SELECT worker_username FROM worker WHERE worker_username='$worker_username'";
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO worker(worker_fullname, worker_username, nicno, contactno, district, worktype, experience, image, password) VALUES ('$worker_fullname', '$worker_username', '$nicno', '$contactno', '$district', '$worktype', '$experience', '$image', '$password')";
